...
- 低于或接近 10MB：灵山大佛、五印坛城、佛前广场、百子戏弥勒、菩提大道、胜境广场。
- 10-15MB：梵宫、九龙灌浴、佛手广场、灵山大照壁、三圣殿、曼龙飞塔、祥符禅寺。
- 祥符禅寺与三圣殿使用 `KHR_mesh_quantization` 才压入 15MB 内；已通过手机端人工观察确认可加载。保留无扩展回退候选，供个别设备兼容性问题时快速切回。
