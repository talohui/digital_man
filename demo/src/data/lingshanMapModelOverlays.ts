...
export const lingshanMapModelOverlays: LingshanMapModelOverlay[] = [
  ...
  },
  {
    ...
    name: '九龙灌浴',
    modelUrl: '/models/lingshan/optimized/jiulong-guanyu.runtime-v1.glb',
    fileSizeLabel: '44 MB',
    positionSource: 'navLocation',
    height: 51,
    scale: 240,
  ...
  },
  {
    poiId: 'puti_avenue',
    name: '菩提大道',
    modelUrl: '/models/lingshan/optimized/bodhi-avenue.runtime-v1.glb',
    fileSizeLabel: '23 MB',
    positionSource: 'navLocation',
    height: 11,
    scale: 180,
  ...
  },
  {
    ...
    name: '灵山大照壁',
    modelUrl: '/models/lingshan/optimized/lingshan-dazhaobi.runtime-v1.glb',
    fileSizeLabel: '28 MB',
    positionSource: 'navLocation',
    height: 6,
    scale: 150,
