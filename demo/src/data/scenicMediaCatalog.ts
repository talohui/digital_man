...
export const routeMediaCatalog: Record<ScenicMediaRouteId, ScenicMediaEntry> = {
  historical_culture: poiMedia('/intro/splash/splash-01.webp', '历史文化路线'),
  prayer_meditation: poiMedia('/intro/splash/splash-03.webp', '祈福静心路线'),
  highlights_checkin: poiMedia('/intro/splash/splash-02.webp', '精华打卡路线'),
  natural_scenery: poiMedia('/intro/splash/splash-05.webp', '自然风光路线'),
  family: poiMedia('/intro/splash/splash-04.webp', '亲子路线')
}
...
const routeAliases: Record<string, ScenicMediaRouteId> = {
  ...
  '祈福静心': 'prayer_meditation',
  '祈福静心路线': 'prayer_meditation',
  'pray-calm': 'prayer_meditation',
  '精华打卡': 'highlights_checkin',
  '精华打卡路线': 'highlights_checkin',
  photo: 'highlights_checkin',
